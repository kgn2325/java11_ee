...
public class StreamExam {
	...
	public static void main(String[] args) throws IOException {
		...
		String bufferInputStream = "BufferedInputStream 는 바이트 단위로 입력하기 위한 스트림 : 메모리 버퍼로 로딩 후";
		...
		String bufferOutputStream = "BufferedOutputStream는 바이트 단위로 출력하기 위한 스트림 : 메모리 버퍼로 로딩 후";
