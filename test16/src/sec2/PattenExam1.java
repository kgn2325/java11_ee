...
public class PattenExam1 {

	public static void main(String[] args) {
		String[] dt = {"bag","kim1004","9to6","8to5","single","Mom","ABC","김기태","^ㅡ^","4536"};
		...
		//Pattern p = Pattern.compile("s[A-Za-z]*");//s로 시작하면서 영문 대소문자 또는 소문자로만 구성된 데이터
		//Pattern p = Pattern.compile("[가-힣]*");//한글로만 구성된 데이터 한글 가장 끝이 힣이다.
