...
public class CalendarExam {
	...
	public static void main(String[] args) {
		...
		System.out.println("오늘은 "+month+"월의"+doy+"일 째");
		System.out.println("오늘은 이번주의  "+doy+"일 째");
		...
		if(ampm==0)
		{
			System.out.println("현재 시간(12시간제) : "+"오전 "+hour12+":"+minute+":"+second);
		}else
		{
			System.out.println("현재 시간(12시간제) : "+"오후 "+hour12+":"+minute+":"+second);
		}
