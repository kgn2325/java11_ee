...
public class TreeMapExam {
	...
	public static void main(String[] args) {
		...
		System.out.println("map2d에서 가장 첫 엔트리 : "+map2.firstEntry());
		System.out.println("map2d에서 가장 첫 키 : "+map2.firstKey());
		System.out.println("map2d에서 가장 마지막 엔트리 : "+map2.lastEntry());
		System.out.println("map2d에서 가장 마지막 키 : "+map2.lastKey());
	}
