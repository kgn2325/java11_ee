...
public class HashMapExam {
	...
	public static void main(String[] args) {
		//선언 방법
		Map<String, String> map0 = new HashMap<String,String>();//형변환 가능 Map 인터페이스를 활용한 HashMap생성
		HashMap<String, String> map1 = new HashMap<String,String>();// 형변환 불가능 HashMap 선언 및 생성 표준식
		...
		HashMap<String, String> map4 = new HashMap<>(10);//초기 용량 지정 -> 초기 용량 지정보다 더 많은 데이터를 저장하게 되면, 자동적으로 초기 용량의 배로 증가된다.
		...
		{
			int key =k;
			System.out.println(k+"="+fruits.get(key));
		}
