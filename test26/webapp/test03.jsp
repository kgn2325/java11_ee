...
<div>
	...
	<form action="test03_post.jsp" method="post">
		<input type="number" size="40" name="no" id="no" value="1" min="1" max="100" required>
		<input type="text" size="40" name="id" id="id" placeholder="아이디 입력" required>
		<input type="password" size="40" name="pw" id="pw" placeholder="비밀번호 입력" required>
		<input type="text" size="40" name="name" id="name" placeholder="이름 입력" required>
		<div>
			<h4>좋아하는 스포츠</h4>
			...
			<input type="checkbox" name="sports" id="sports3" value="농구"><label for="sports3">농구</label><br>
			<input type="checkbox" name="sports" id="sports4" value="배구"><label for="sports4">배구</label><br>
